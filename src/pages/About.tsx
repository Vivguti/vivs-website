...
export default function About() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[#1a2340]/45" />
      ...
      >
        ...
        <p className="font-body text-xl text-white/90 font-semibold tracking-wide text-shadow-subtle">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5 flex flex-col gap-8">
          <GlassPanel delay={0.2} heavy>
            <div className="flex flex-col gap-6">
              <div className="flex items-center gap-4 text-white">
                <div className="w-10 h-10 rounded-full bg-white/40 border border-white/60 flex items-center justify-center shrink-0 shadow-sm text-white">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <rect x="2" y="4" width="20" height="16" rx="2" />
                    <polyline points="22,4 12,13 2,4" />
                  </svg>
                </div>
                <a href="mailto:Vivguti09@gmail.com" className="font-body text-lg font-semibold text-white hover:text-white/80 transition-colors drop-shadow-sm">
                  Vivguti09@gmail.com
                </a>
              </div>
              <div className="flex items-center gap-4 text-white">
                ...
                <a href="tel:3464051003" className="font-body text-lg font-semibold text-white hover:text-white/80 transition-colors drop-shadow-sm">
                  (346) 405-1003
                </a>
              </div>
              <div className="flex items-center gap-4 text-white">
                ...
                <a href="https://www.linkedin.com/in/vivguti/" target="_blank" rel="noreferrer" className="font-body text-lg font-semibold text-white hover:text-white/80 transition-colors break-all drop-shadow-sm">
          ...
          <GlassPanel delay={0.3}>
            <h2 className="font-display text-2xl font-bold text-white mb-8 uppercase tracking-wider border-b border-white/30 pb-4 text-shadow-subtle">
                ...
                <div className="flex flex-col gap-3">
                  {['Rhino', 'Sketchup', 'AutoCAD', 'Revit'].map((skill, i) => (
                    <motion.div
                      ...
                      className="glass-panel w-full py-4 px-6 rounded-xl flex items-center justify-between hover:bg-white/50 transition-all duration-300 cursor-default group shadow-sm"
                    >
        ...
        <div className="lg:col-span-7 flex flex-col gap-8">
          ...
          <GlassPanel delay={0.25}>
            <h2 className="font-display text-2xl font-bold text-white mb-4 uppercase tracking-wider border-b border-white/30 pb-4 text-shadow-subtle">
          ...
          <GlassPanel delay={0.35}>
            ...
            <div className="flex flex-col gap-8 relative border-l-2 border-white/50 pl-6 ml-2">
              ...
              <div className="relative">
                <div className="absolute w-3.5 h-3.5 bg-white/80 rounded-full -left-[32px] top-1.5" />
          ...
          <GlassPanel delay={0.45}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h2 className="font-display text-2xl font-bold text-white mb-6 uppercase tracking-wider border-b border-white/30 pb-4 text-shadow-subtle">
                  Education
                </h2>
                <div className="mb-6">
