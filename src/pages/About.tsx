          ...
          <GlassPanel delay={0.2} className="!bg-white/30 !backdrop-blur-[50px] border border-white/45 shadow-lg">
            <div className="flex flex-col gap-6">
              <div className="flex items-center gap-4 text-white">
                <motion.div 
                  whileHover={{ scale: 1.12, backgroundColor: "rgba(255, 255, 255, 0.45)" }}
                  transition={{ type: "spring", stiffness: 400, damping: 20 }}
                  className="w-10 h-10 rounded-full bg-white/30 border border-white/50 flex items-center justify-center shrink-0 shadow-sm text-white cursor-pointer"
                >
                ...
                <div className="flex flex-col gap-3">
                  {['Rhino', 'Sketchup', 'AutoCAD', 'Revit'].map((skill, i) => (
                    <motion.div
                      ...
                      whileHover={{ x: 8, backgroundColor: 'rgba(255, 255, 255, 0.35)', borderColor: 'rgba(255, 255, 255, 0.6)' }}
                      ...
                      className="bg-white/20 border border-white/35 backdrop-blur-[50px] w-full py-4 px-6 rounded-xl flex items-center justify-between cursor-pointer group shadow-sm transform-gpu"
                    >
